...
| <factor><producto_opcional><suma_opcional>)…                             | 2 + 3 ) * 2 FIN.                            | δ(q2, λ, <factor>) = (q2, <numero>)                                       |
| <numero><producto_opcional><suma_opcional>)…                             | 2 + 3 ) * 2 FIN.                            | δ(q2, λ, <numero>) = (q2, <digito><num_rest>)                             |
| <digito><num_rest><producto_opcional><suma_opcional>)…                   | 2 + 3 ) * 2 FIN.                            | δ(q2, 2, <digito>) = (q2, λ)                                              |
| <num_rest><producto_opcional><suma_opcional>)…                           |  + 3 ) * 2 FIN.                     | δ(q2, ‘ ’, λ) = (q2, λ)                                                   |
| <num_rest><producto_opcional><suma_opcional>)…                           | + 3 ) * 2 FIN.                              | δ(q2, λ, <num_rest>) = (q2, λ)                                            |
| <producto_opcional><suma_opcional>)…                                     | + 3 ) * 2 FIN.                              | δ(q2, λ, <producto_opcional>) = (q2, λ)                                   |
| <suma_opcional>)<producto_opcional><suma_opcional><bloque>FIN.#          | + 3 ) * 2 FIN.                              | δ(q2, λ, <suma_opcional>) = (q2, <op_suma><termino><suma_opcional>)       |
| <op_suma><termino><suma_opcional>)…                                      | + 3 ) * 2 FIN.                              | δ(q2, +, +) = (q2, λ)                                                     |
| <termino><suma_opcional>)…                                               |  3 ) * 2 FIN.                       | δ(q2, ‘ ’, λ) = (q2, λ)                                                   |
| <termino><suma_opcional>)…                                               | 3 ) * 2 FIN.                                | δ(q2, λ, <termino>) = (q2, <factor><producto_opcional>)                   |
| <factor><producto_opcional><suma_opcional>)…                             | 3 ) * 2 FIN.                                | δ(q2, λ, <factor>) = (q2, <numero>)                                       |
| <numero><producto_opcional><suma_opcional>)…                             | 3 ) * 2 FIN.                                | δ(q2, λ, <numero>) = (q2, <digito><num_rest>)                             |
| <digito><num_rest><producto_opcional><suma_opcional>)…                   | 3 ) * 2 FIN.                                | δ(q2, 3, <digito>) = (q2, λ)                                              |
| <num_rest><producto_opcional><suma_opcional>)…                           |  ) * 2 FIN.                         | δ(q2, ‘ ’, λ) = (q2, λ)                                                   |
| <num_rest><producto_opcional><suma_opcional>)…                           | ) * 2 FIN.                                  | δ(q2, λ, <num_rest>) = (q2, λ)                                            |
| <producto_opcional><suma_opcional>)…                                     | ) * 2 FIN.                                  | δ(q2, λ, <producto_opcional>) = (q2, λ)                                   |
| <suma_opcional>)…                                                        | ) * 2 FIN.                                  | δ(q2, λ, <suma_opcional>) = (q2, λ)                                       |
...
| <op_mul><factor><producto_opcional><suma_opcional>…                      | * 2 FIN.                                    | δ(q2, *, *) = (q2, λ)                                                     |
| <factor><producto_opcional><suma_opcional><bloque>FIN.#                  | (espacio)2 FIN.                             | δ(q2, ‘ ’, λ) = (q2, λ)                                                   |
| <factor><producto_opcional><suma_opcional><bloque>FIN.#                  | 2 FIN.                                      | δ(q2, λ, <factor>) = (q2, <numero>)                                       |
| <numero><producto_opcional><suma_opcional>…                              | 2 FIN.                                      | δ(q2, λ, <numero>) = (q2, <digito><num_rest>)                             |
| <digito><num_rest><producto_opcional>…                                   | 2 FIN.                                      | δ(q2, 2, <digito>) = (q2, λ)                                              |
| <num_rest><producto_opcional><suma_opcional>…                            |  FIN.                                       | δ(q2, ‘ ’, λ) = (q2, λ)                                                   |
| <num_rest><producto_opcional><suma_opcional>…                            | FIN.                                        | δ(q2, λ, <num_rest>) = (q2, λ)                                            |
